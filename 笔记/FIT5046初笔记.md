...
a number of autonomous entities (most likely heterogeneous) which are geographically distributed can **communicate and exchange messages through a computer network** to achieve certain related tasks
